...
public class ShipweightTransformationService : IDatabaseTransformationService
{
    IRdfTransformationService _rdfTransformationService;
    public ShipweightTransformationService(IRdfTransformationService rdfTransformationService)
    {
